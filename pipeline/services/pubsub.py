...
class PublisherClient:
    ...
    def __init__(
        ...
        topic_id: str,
        logger: Logger,
        publish_timeout_in_seconds: Optional[int]=None) -> None:
    ...
    def publish_message(self, data: Dict) -> None:
        ...
        try:
            ...
            raise RuntimeError("Failed to publish Pub/Sub message "
                               f"for \"{data_str}\". {e}") from None
...
class SubscriberClient:
    ...
    def __init__(
        ...
        Args:
            ...
            subscription_id (`str`): The name of the subscription
                from which messages will be pulled.

            msg_batch_size (`int`): The maximum number of 
                messages to pull at once from the subscription.

            msg_retry_deadline (`int`): The number of seconds to
    ...
    def acknowledge_message(self, msg: ReceivedMessage) -> None:
        ...
        Args:
            msg (`ReceivedMessage`): The message.
    ...
    def pull(self) -> List[ReceivedMessage]:
        ...
        Returns:
            (`list` of `ReceivedMessage`): The messages.
        """
