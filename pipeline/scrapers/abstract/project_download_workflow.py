...
from pipeline.constants import COMPLETED_STATUS, ERROR_STATUS
    ...
    def execute(
        ...
        try:
            ...
            try:
                ...
                raise Exception("Failed to insert new project "
                                f"records into database. {e}")
        
        except Exception as e:
            # Log error
            error_message = ("Project download task failed for "
