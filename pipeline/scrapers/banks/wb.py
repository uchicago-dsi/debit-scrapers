...
from pipeline.constants import WB_ABBREVIATION
...
class WbDownloadWorkflow(ProjectDownloadWorkflow):
    ...
    def download_url(self) -> str:
        ...
        """
        return "http://search.worldbank.org/api/projects/all.xls"
    ...
    def get_projects(self) -> pd.DataFrame:
        ...
        if not r.ok:
            raise RuntimeError("Error fetching Excel project data file "
        ...
        try:
            return pd.read_excel(r.content, skiprows=2, engine="xlrd")
        except Exception as e:
            raise RuntimeError(f"Error reading Excel project data "
                f"from the World Bank into Pandas DataFrame. {e}") from None
    ...
    def clean_projects(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        try:
            ...
            col_mapping = {
                ...
                "curr_total_commitment": "loan_amount",
