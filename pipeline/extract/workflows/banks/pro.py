"""Data extraction workflows for the development bank Proparco.
...
class ProResultsScrapeWorkflow(ResultsScrapeWorkflow):
    ...
    def scrape_results_page(self, url: str) -> List[str]:
        """Requests a Proparco search results page and then
        scrapes all individual project URLs from that page.
