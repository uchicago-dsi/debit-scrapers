'''
project_partial_scrape_workflow.py

Provides a client that outlines the series
of steps necessary to scrape a project page
for a development bank and then PATCH the
corresponding project record in a database
...
class ProjectPartialScrapeWorkflow(BaseWorkflow):
    ...
    def __init__(
        ...
        logger: Logger) -> None:
        '''
        The public constructor for `ProjectPartialScrapeWorkflow`.
