...
class AdbProjectScrapeWorkflow(ProjectScrapeWorkflow):
    ...
    def _process_activity(self, activity: etree._Element) -> dict:
        ...
        project["finance_types"] = [self._finance_type_codes.get(finance_type_code)]
            ...
            aggregated_projects.append(
                {
                    ...
                    "date_planned_close": parse_max_date(grp["date_planned_close"]),
                    "date_actual_close": parse_max_date(grp["date_actual_close"]),
                    ...
                    "total_amount_usd": parse_amount(grp["total_amount_usd"].sum()),
                    "total_amount_currency": grp["total_amount_currency"].iloc[0],
                    "url": grp["url"].iloc[0],
                }
            )
