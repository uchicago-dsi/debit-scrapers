"""Data extraction workflows for the Multilateral Investment
Guarantee Agency (MIGA). Data is retrieved by generating a
list of all possible search result pages, scraping individual
project URLs from those pages, scraping fields from each project
page, and then mapping the fields to an expected output schema.
"""
    ...
    def scrape_results_page(self, results_page_url: str) -> List[str]:
        ...
        try:
            ...
            r = self._data_request_client.get(
                results_page_url, use_random_user_agent=True
            )
