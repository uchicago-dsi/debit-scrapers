"""Data extraction workflows for the Inter-American Development Bank (IDB).
...
class IdbProjectDownloadWorkflow(ProjectDownloadWorkflow):
    ...
    def clean_projects(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        def format_countries(val: str | None) -> str | None:
            """Transforms a string of country names into a
            pipe-delimited string with erroneneous values removed.
