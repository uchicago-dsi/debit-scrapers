"""Data extraction workflows for the Asian Infrastructure Investment
Bank (AIIB). Data is retrieved by requesting a JavaScript file
containing a list of all project page URLs and then requesting and
