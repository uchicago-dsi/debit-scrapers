"""Data extraction workflows for the Belgian Investment Company
for Developing Countries (BIO). Data is retrieved by scraping
project search result webpages for project details and links
to project overview pages. The overview pages are then scraped
themselves for information on project sectors and companies.
"""
